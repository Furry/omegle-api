...
function confirmTerms(a, b) {
    ...
    if (1 === a)
        ...
        var m = d()
          , l = d();
    m.appendChild(document.createTextNode("By checking the box you acknowledge that you have reviewed and agree to be bound by Omegle’s "));
    var n = document.createElement("a");
    n.target = "_blank",
    n.href = "/static/terms.html",
    n.appendChild(document.createTextNode("Terms of Service")),
    m.appendChild(n),
    m.appendChild(document.createTextNode(", "));
    var o = document.createElement("a");
    o.target = "_blank",
    o.href = "/static/privacy.html",
    o.appendChild(document.createTextNode("Privacy Policy")),
    m.appendChild(o),
    m.appendChild(document.createTextNode(", and "));
    var p = document.createElement("a");
    if (p.target = "_blank",
    p.href = "/static/guidelines.html",
    p.appendChild(document.createTextNode("Community Guidelines")),
    m.appendChild(p),
    m.appendChild(document.createTextNode(".")),
    1 === a) {
        var q = document.createElement("strong");
        q.appendChild(document.createTextNode("OUR AGE RESTRICTIONS HAVE CHANGED. YOU MUST BE 18 OR OLDER TO USE OMEGLE.")),
        l.appendChild(q),
        l.appendChild(document.createTextNode(" Persons under the age of 18 "));
        var r = document.createElement("strong");
        r.appendChild(document.createTextNode("may not")),
        l.appendChild(r),
        l.appendChild(document.createTextNode(" use Omegle. See our updated "));
        var s = document.createElement("a");
        s.target = "_blank",
        s.href = "/static/terms.html",
        s.appendChild(document.createTextNode("Terms of Service")),
        l.appendChild(s),
        l.appendChild(document.createTextNode(" for more info. "));
        var t = document.createElement("strong");
        t.appendChild(document.createTextNode("By checking the box you acknowledge and represent that you comply with these age restrictions.")),
        l.appendChild(t)
    } else {
        l.appendChild(document.createTextNode("You may not use this service if you are under the age of 18 or the age of legal majority in your jurisdiction. See our "));
        var s = document.createElement("a");
        s.target = "_blank",
        s.href = "/static/terms.html",
        s.appendChild(document.createTextNode("Terms of Service")),
        ...
        l.appendChild(document.createTextNode(" for more info. "));
        var t = document.createElement("strong");
        t.appendChild(document.createTextNode("By checking the box you acknowledge and represent that you are 18 years (or the age of legal majority in your jurisdiction) or older.")),
        l.appendChild(t)
    }
    ...
    if (!basicReadyCalled) {
        ...
        if (IS_MOBILE && testRTCSupport() && $("chatbtnwrapper") && $("chatbtn")) {
            ...
            $("chatbtnwrapper").grab(new Element("p",{
                text: "Video is monitored, so keep it clean!",
                styles: {
                    textAlign: "center"
                }
            }), "before"),
...
function googleTranslateElementFullyLoaded() {
    if ("undefined" != typeof googTr && googTr.W && googTr.ba && "string" == typeof googTr.W && "string" == typeof googTr.ba && ("en" !== googTr.W.substr(0, 2).toLowerCase() || "en" !== googTr.ba.substr(0, 2).toLowerCase()) && $("google_translate_wrapper") && $("google_translate_lower_container") && $("google_translate_lower_container").grab) {
        $("google_translate_lower_container").grab($("google_translate_wrapper")),
        $("google_translate_lower_container").grab(new Element("br"));
        var a = "English";
        googTr.I && "string" == typeof googTr.I.en && (a = googTr.I.en),
...
function startNewChat(a, b, c, d, e, f) {
    ...
    confirmTerms(e ? 2 : 1, function() {
        ...
        function F() {
            ...
            window.visualViewport && (visualViewport.removeEventListener("resize", Ha),
            visualViewport.removeEventListener("scroll", Ha))),
        ...
        function I() {
            if (!IS_MOBILE) {
                ...
                if (unmonSexyButton.addEvent("click", function() {
                    ...
                    b += a ? "video" : "text",
                    confirmAdultSite() && window.open("https://wawadmin.omegle.com/redir/" + (IS_MOBILE ? "mob" : "y") + "?track=" + b + unmonSexyTrack)
                }),
                null === unmonGayButton) {
                ...
                unmonGayButton.addEvent("click", function() {
                    ...
                    var b = "unmon-upper-" + (shouldForceUnmonitored ? "" : "not") + "forced-";
                    b += a ? "video" : "text",
                    confirmAdultSite() && window.open("https://wawadmin.omegle.com/redir/gay?track=" + b + unmonGayTrack)
                });
                var d = new Element("div");
        ...
        function J(f) {
            ...
            if (!db) {
                ...
                N.grab(middotify(U)));
                var Z = aurrp;
                if (ja || ka && la ? v(N, !1, !1) : !a || f || IS_MOBILE || e || o(),
            ...
            var d = new Element("button",{
                ...
                events: {
                    click: function(a) {
                        a.preventDefault(),
                        cb && cb(),
                        confirmAdultSite() && window.open("https://wawadmin.omegle.com/redir/y?track=" + c)
                    }
                }
            });
            b.grab(d),
              ...
              , g = new Element("button",{
                ...
                events: {
                    click: function(a) {
                        a.preventDefault(),
                        cb && cb(),
                        confirmAdultSite() && window.open("https://wawadmin.omegle.com/redir/gay?track=" + c)
                    }
                }
            });
            return f.grab(g),
        ...
        function S() {
            if (rb.getSize && rb.getPosition && $(window).getSize) {
                ...
                window.visualViewport && (a = {
                    y: window.visualViewport.height,
                    x: window.visualViewport.width
                });
                var b = screen.msOrientation || screen.mozOrientation || (screen.orientation || {}).type;
                ...
                window.visualViewport && rb.setStyles({
        ...
        function X() {
            ...
            window.open("https://wawadmin.omegle.com/redir/y?track=interchat-" + Hb))
        }
        function Y(a) {
            (new Image).src = "https://wawadmin.omegle.com/redir/interchatexit?track=" + a + "-" + Hb
        }
        function Z() {
            (new Image).src = "https://wawadmin.omegle.com/redir/interchatenter?track=" + Hb
        }
        function _() {
        ...
        function fa(a) {
            a.sdp = ba(a.sdp),
            Tb.setLocalDescription(a).then(function() {
        ...
        function ha() {
            ...
            Tb.addStream ? Tb.addStream(userMedia) : userMedia.getTracks().forEach(function(a) {
                Tb.addTrack(a, userMedia)
            }),
            x("Connecting to server..."),
            IS_MOBILE || ub.setStyle("display", "block"),
            sb.addEventListener("play", _, !1),
            Ma.connect(null, null, !1, !1, yb, Ab, e ? "unmon" : null, Sb, cameraName, !0, Cb, Db, Eb),
            serverManager.unsetKnownGood(),
            ...
            if (!db)
                ...
                ja)
                    ...
                    if (11 === b.getMonth() && 25 === b.getDate())
                        ...
                        var c, d = ["STAND WITH THE CHINESE PEOPLE AGAINST THE CCP"], c = d[Math.floor(d.length * Math.random())];
        ...
        a) {
            ...
            e && !$("abovevideosexybtn") && $("videowrapper").grab(new Element("div",{
                ...
                events: {
                    click: function(a) {
                        a.preventDefault(),
                        cb && cb(),
                        confirmAdultSite() && window.open("https://wawadmin.omegle.com/redir/y?track=avc-108-" + (doAVCtest ? "y" : "n"))
                    }
                },
            ...
            window.visualViewport && (visualViewport.addEventListener("resize", T),
            visualViewport.addEventListener("scroll", T)),
            Ha = T
        } else
            var rb = null
              , sb = null
        ...
        if (e) {
            ...
            unmonAdCount < 1 && unmonChatCount >= 4) {
                ...
                Kb.setStyle("padding-bottom", "3.5em");
                ...
                var Qb = new Element("div",{
                    ...
                    events: {
                        click: function() {
                            ...
                            window.open("https://wawadmin.omegle.com/redir/gay?track=interchat-" + Hb))
                        }
                    }
                })
                  , Rb = new Element("span",{
        ...
        var Sb = null;
        if (shouldUseEnglish && !zb || ("undefined" != typeof googTr && googTr.W && "string" == typeof googTr.W && googTr.W.length >= 2 ? Sb = googTr.W.substr(0, 2) : "undefined" != typeof navigator && "string" == typeof navigator.language && (Sb = navigator.language.substr(0, 2))),
        a) {
            var Tb = new RTCPeerConnection(WEB_RTC_CONFIG,WEB_RTC_PEER_CONSTRAINTS);
            Tb.ontrack = function(a) {
                sb.srcObject = a.streams[0]
            }
            ;
            var Ub = []
              , Vb = null;
            Tb.onicecandidate = function(a) {
                null !== Tb && (null !== Vb && (clearTimeout(Vb),
                Vb = null),
                a.candidate && Ub.push(a.candidate),
                a.candidate && "complete" !== Tb.iceGatheringState ? Vb = setTimeout(function() {
                    Ub.length && (Ma.sendICECandidates(Ub),
                    Ub = []),
                    Vb = null
                }, 10) : Ub.length && (Ma.sendICECandidates(Ub),
                Ub = []))
            }
            ;
            var Wb = !1
            ...
            Ma.addEvent("icecandidate", function(a) {
                if (!Yb)
                    return void Xb.push(a);
                try {
                    Tb.addIceCandidate(new RTCIceCandidate(a))
                } catch (b) {
                    console.log(b)
                }
            }),
            Ma.addEvent("rtccall", function() {
                Wb = !0,
                null !== Tb && Tb.createOffer(WEB_RTC_MEDIA_CONSTRAINTS).then(fa, aa)
            }),
            Ma.addEvent("rtcpeerdescription", function(a) {
                a = new RTCSessionDescription(a),
                null !== Tb && Tb.setRemoteDescription(a).then(function() {
                    Yb = !0;
                    for (var a = 0; a < Xb.length; a++)
                        try {
                            Tb.addIceCandidate(new RTCIceCandidate(Xb[a]))
                        } catch (b) {
                            console.log(b)
                        }
                    Xb = [],
                    Wb || setTimeout(function() {
                        if (null !== Tb) {
                            Tb.createAnswer(WEB_RTC_MEDIA_CONSTRAINTS).then(function(a) {
                                fa(a)
                            }, aa)
                        }
                    }, 0)
            ...
            Ma.connect(null, b, c, d, yb, Ab, e ? "unmon" : null, Sb, null, !1, Cb, Db, Eb),
            serverManager.unsetKnownGood()
    })
}
...
var COMETBackend = new Class({
    ...
    gotReqWindow: function() {
        var a = this;
        getCheckCode(function(b) {
            a.gotCheckCode(b)
        })
    },
    gotCheckCode: function(a) {
        var b = this
          , c = b.stratusNearID || ""
          , d = subdomainManager.fixUrl(b.server, "/start?caps=recaptcha2,t3&firstevents=1&spid=" + c + "&randid=" + randID + (IS_MOBILE ? "&m=1" : "") + "&cc=" + a);
        "string" == typeof b.askedQuestion && (d += "&ask=" + encodeURIComponent(b.askedQuestion)),
        "string" == typeof b.fbAccessToken && (d += "&fbaccesstoken=" + encodeURIComponent(b.fbAccessToken)),
        b.wantsSpy && (d += "&wantsspy=1"),
        b.canSaveQuestion && (d += "&cansavequestion=1"),
        b.topics && b.topics.length && (d += "&topics=" + encodeURIComponent(JSON.encode(b.topics))),
        b.group && (d += "&group=" + encodeURIComponent(b.group)),
        b.lang && (d += "&lang=" + encodeURIComponent(b.lang)),
        b.camera && (d += "&camera=" + encodeURIComponent(b.camera)),
        b.enableWebRTC && (d += "&webrtc=1"),
        b.college && (d += "&college=" + encodeURIComponent(b.college)),
        b.collegeAuth && (d += "&college_auth=" + encodeURIComponent(b.collegeAuth)),
        b.anyCollege && (d += "&any_college=1");
        var e = null
          , f = killHeaders(new b.reqWindow.Request.JSON({
            url: d,
            onSuccess: function(a) {
                if (null !== e) {
                    if (clearTimeout(e),
                    e = null,
                    !a.clientID)
                        return void b.fireEvent("permanentlyFailedToConnect");
                    b.clientID = a.clientID,
                    b.fireEvent("connectedToServer"),
                    a.events && b.gotEvents(a.events),
                    b.getEvents()
                }
            },
            onFailure: function() {
...
var topicManager = function() {
    ...
    var c = function() {
        if (antinudeServers.length) {
            var d = false
            var e = antinudeServers[$random(0, antinudeServers.length - 1)]
            var f = new XMLHttpRequest;
            f.onreadystatechange = function() {
                if (!d && f.readyState === XMLHttpRequest.DONE) {
                    if (d = !0, 200 !== f.status)
                        return void setTimeout(c, 3e3 + 1e3 * Math.random());
                    if (b = f.responseText, a.length) {
                        for (var e = 0; e < a.length; e++)
                            a[e](b);
                        a = []
                    }
