function setCollegeMode(a) {
	collegeMode = a, Cookie.write("collegemode", collegeMode, {
		duration: 365,
...
function clearCollegeSetting() {
	Cookie.write("college", "", {
		...
		domain: document.domain,
		path: "/"
	}), collegeAndAuth = null, collegeMode = "any"
}

function middotify(a) {
	for (var b = new Element("span"), c = 0; c < a.length; c++) c > 0 && b.appendText(" â€¢Â "), b.grab(a[c]);
	return b
}
...
function confirmTerms(a, b) {
	...
	function d() {
		...
		c.type = "checkbox", c.style.fontSize = "1.5em", c.style.width = "1em", c.style.height = "1em", c.style["float"] = "left", c.style.marginRight = "0.5em", b.appendChild(c), b.appendChild(document.createTextNode(" "));
		var d = i.length;
		return i.push(!1), j.push(c), c.addEventListener("change", function() {
			i[d] = c.checked;
			for (var a = !0, b = 0; b < i.length; b++) i[b] || (a = !1);
			h.disabled = !a, h.style.pointerEvents = a ? "auto" : "none"
		}), a.appendChild(b), f.appendChild(a), b
	}
	if (termsLevel >= a) return void b();
	var e = document.createElement("div");
	e.style.position = "fixed", e.style.top = 0, e.style.left = 0, e.style.width = "100%", e.style.height = "100%", e.style.overflow = "auto", e.style.zIndex = "10000", e.style.backgroundColor = "#000", e.style.backgroundColor = "rgba(0, 0, 0, 0.4)";
	var f = document.createElement("div");
	f.style.position = "relative", f.style.backgroundColor = "#FFF", f.style.margin = "15% auto", f.style.padding = "1em", f.style.width = "50%", f.style.minWidth = "300px", f.style.boxShadow = "5px 5px 10px 5px rgba(0, 0, 0, 0.333)", IS_MOBILE && (f.style.width = "80%"), f.style.borderRadius = "2em";
	var g = document.createElement("a");
	g.href = "#", g.style.color = "#555", g.style.textDecoration = "none", g.style.fontSize = "2em", g.style.position = "absolute", g.style.top = ".25em", g.style.right = ".5em", g.style.lineHeight = "1", g.appendChild(document.createTextNode("Ã—")), g.addEventListener("click", function(a) {
		a.preventDefault(), c()
	}), f.appendChild(g);
	var h = document.createElement("input");
	h.type = "button", h.value = "Confirm & continue", h.disabled = !0, h.style.fontSize = "1.5em", h.style.pointerEvents = "none", h.addEventListener("click", function() {
		c(), termsLevel = a, b()
	});
	var i = [],
		j = [],
		k = !1,
		l = d();
	l.appendChild(document.createTextNode("By checking the box you acknowledge that you have reviewed and agree to be bound by Omegleâ€™s "));
	var m = document.createElement("a");
	m.target = "_blank", m.href = "/static/terms.html", m.appendChild(document.createTextNode("Terms of Service")), l.appendChild(m), l.appendChild(document.createTextNode(", "));
	var n = document.createElement("a");
	n.target = "_blank", n.href = "/static/privacy.html", n.appendChild(document.createTextNode("Privacy Policy")), l.appendChild(n), l.appendChild(document.createTextNode(", and "));
	var o = document.createElement("a");
	o.target = "_blank", o.href = "/static/guidelines.html", o.appendChild(document.createTextNode("Community Guidelines")), l.appendChild(o), l.appendChild(document.createTextNode("."));
	var p = d();
	if (1 === a) {
		p.appendChild(document.createTextNode("You must be 18+ or 13+ to use Omegle. If you are between 13 and 18 years of age, you may only use Omegle with the permission and under the supervision of your legal guardian. Persons under the age of 13 "));
		var q = document.createElement("strong");
		q.appendChild(document.createTextNode("may not")), p.appendChild(q), p.appendChild(document.createTextNode(" use Omegle. See our "));
		var r = document.createElement("a");
		r.target = "_blank", r.href = "/static/terms.html", r.appendChild(document.createTextNode("Terms of Service")), p.appendChild(r), p.appendChild(document.createTextNode(" for more info. "));
		var s = document.createElement("strong");
		s.appendChild(document.createTextNode("By checking the box you acknowledge and represent that you comply with these age restrictions.")), p.appendChild(s)
	} else {
		...
		r.target = "_blank", r.href = "/static/terms.html", r.appendChild(document.createTextNode("Terms of Service")), p.appendChild(r), p.appendChild(document.createTextNode(" for more info. "));
		var s = document.createElement("strong");
		s.appendChild(document.createTextNode("By checking the box you acknowledge and represent that you are 18 years (or the age of legal majority in your jurisdiction) or older.")), p.appendChild(s)
	}
	var t = document.createElement("p");
	t.style.textAlign = "right", t.appendChild(h), t.addEventListener("click", function() {
		if (h.disabled && !k) {
			var a = [];
			k = !0;
	...
	}), f.appendChild(t), e.appendChild(f), document.body.appendChild(e)
}
...
function startFirstChat(a, b, c, d, e) {
	...
	confirmTerms(e || shouldForceUnmonitored ? 2 : 1, function() {
		...
		f.push(!0), startNewChat.apply(null, f)
	})
}

function showIntro() {
	if (savedHeader && !$("header") && (logoElt && savedHeader.grab(logoElt, "top"), $(document.body).grab(savedHeader)), savedIntro && $(document.body).grab(savedIntro), IS_MOBILE)
...
function commify(a) {
	var b, c = "";
	do {
		for (b = (a % 1e3).toString(), a = Math.floor(a / 1e3); 0 != a && b.length < 3;) b = "0" + b;
		c = b + c, a && (c = "," + c)
	} while (0 != a);
	return c
}
...
function forceUnmon() {
	if (!IS_MOBILE && !shouldForceUnmonitored) {
		...
		if (a) {
			...
			a.getElementById("chattypes").grab(b, "before"), b.addClass("banned");
			var c = new Element("p", {
			...
			b.grab(c), b.grab(d), b.grab(e), a.getElements("#tryspymode, #intoheadercell, #topicsettingscell, #spymodebtn, #videobtnunmoderated").dispose();
			...
			g.addEvent("click", function() {
				confirmAdultSite() && window.open("https://wawadmin.omegle.com/redir/y?track=homepage-ban" + i)
			});
			...
			var l = new Element("img", {
				...
				m = new Element("td");
			m.grab(l), l.addEvent("click", function() {
				confirmAdultSite() && window.open("https://wawadmin.omegle.com/redir/gay?track=homepage-ban")
			});
			var n = (new Element("td", {
				"class": "chattypeorcell",
				text: "or"
			}), new Element("tr"));
			n.grab(h), n.grab(j), n.grab(m), a.getElement("#chattypes tbody").grab(n), $("videobtn").set("src", $("videobtn").get("src").replace("-disabled", "-enabled")), $("videobtnstatus").set("html", "&nbsp;")
		}
	}
}
...
function processTumblrTags(a, b) {
	...
	for (var h = [], e = 0; e < Math.min(b, c.length); e++) h.push(d[c[e]].format);
	return h
}
...
function makeShouldUseLikesCheckbox() {
	...
	}), a.grab(b), a.appendText(" Find strangers with common interests"), a
}
...
function makeCollegeCheckboxes(a) {
	...
	if (a) {
		...
		c.setStyle("font-weight", "bold"), c.set("text", "College: "), c.appendText(collegeAndAuth[0]), c.appendText(" "), c.grab(a), b.grab(c)
	}
	...
	e.addEvent("change", function() {
		g.checked = !1, setCollegeMode(e.checked ? "my" : "none")
	}), d.grab(e), a ? d.appendText(" Find strangers from my college") : d.appendText(" " + collegeAndAuth[0]), b.grab(d), a ? b.grab(new Element("br")) : b.appendText(" ");
	var f = new Element("label"),
		g = new Element("input", {
			type: "checkbox"
		});
	return g.addEvent("change", function() {
		e.checked = !1, setCollegeMode(g.checked ? "any" : "none")
	}), f.grab(g), f.appendText(" Any college"), b.grab(f), "my" === collegeMode ? e.checked = !0 : "any" === collegeMode && (g.checked = !0), b
}
...
function makeCollegeEmailForm(a) {
	var b = new Element("div"),
		...
		f = new Element("a", {
			...
			events: {
				click: function(a) {
					a.preventDefault(), b.grab(g), k.focus(), e.dispose()
				}
			}
		});
	f.setStyles({
		...
		"border-radius": "0.5em",
		position: "relative"
	}), f.setStyle("padding-left", a ? "0.25em" : "2em"), f.grab(new Element("span", {
		text: "â–¶",
		styles: {
			position: "absolute",
			left: "1em",
		...
		events: {
			submit: function(a) {
				function b(a, b) {
					...
					k.set("disabled", !1), l.set("disabled", !1), k.set("value", "")
				}
				a.preventDefault(), m.empty(), k.set("disabled", !0), l.set("disabled", !0);
				var c = serverManager.pickServer();
	...
	h.set("html", "Please enter a college email address <strong>ending in .edu or .edu.XX or .ac.XX</strong> to verify you're in college. This will allow you to chat with other college students."), g.grab(h);
	...
	i.appendText(" "), i.grab(l), g.grab(i);
	...
	return n.set("html", "<strong>We WON'T spam you, sell your address, or save it.</strong><br>We'll email you to verify your college address, and that's all. Other users won't see your address, only the domain (the part after the @ sign)."), g.grab(n), b
}
...
function basicReady() {
	if (!basicReadyCalled) {
		...
		if (IS_MOBILE && testRTCSupport() && $("chatbtnwrapper") && $("chatbtn")) {
			...
			$("chatbtnwrapper").grab(b), $("chatbtnwrapper").grab(new Element("p", {
...
function onReady() {
	function a() {
		...
		a.form.setStyle("marginTop", "0.5em"), a.form.setStyle("marginBottom", "0.5em"), $("tryspymodetext").appendText("Spy mode lets you ask a question and watch two strangers discuss it. (The strangers volunteer to be watched.)"), $("tryspymodetext").grab(new Element("br")), $("tryspymodetext").appendText("Ask anything you like, but try to keep questions open-ended and thought-provoking."), $("tryspymodetext").grab(a.form);
		var b = new Element("div"),
			c = new Element("button", {
				text: "Ask strangers"
			});
		c.addEvent("click", a.go), b.grab(c), $("tryspymodetext").grab(b);
		var d = new Element("div");
		d.setStyle("font-size", "0.9em"), d.set("text", "Or you can try ");
		var e = new Element("a");
		e.set("text", "discussing questions"), e.set("href", "javascript:"), e.addEvent("click", function(a) {
			a.preventDefault(), startFirstChat(!1, null, !0, !1)
		}), d.grab(e), d.appendText(" instead."), $("tryspymodetext").grab(d), a.focus()
	}

	function b() {
		$("tryspymodetext").empty(), $("tryspymodetext").set("html", "Spy mode gives you and a stranger a <strong>random question</strong> to discuss. The question is submitted by a third stranger who can watch the conversation, but can't join in.");
		var b = new Element("button", {
			text: "Check it out!"
		});
		b.addEvent("click", function(a) {
			a.preventDefault(), startFirstChat(!1, null, !0, !1)
		}), $("tryspymodetext").grab(new Element("br")), $("tryspymodetext").grab(b);
		var c = new Element("div");
		c.setStyle("font-size", "0.9em"), c.set("text", "Or you can try ");
		var d = new Element("a");
		d.set("text", "asking a question"), d.set("href", "javascript:"), d.addEvent("click", function(b) {
			b.preventDefault(), a()
		}), c.grab(d), c.appendText(" instead."), $("tryspymodetext").grab(c)
	}

	function c() {
		$("textbtnstatus") && $("textbtnstatus").empty(), $("tryspymode").setStyle("display", "block"), $("tryspymode").removeEvents("click"), $("tryspymode").removeClass("collapsed"), "spy" == idealSpyMode ? a() : b()
	}
	...
	if ($("topicsettingscontainer") && $("topicsettingscontainer").grab(e), collegeJustEnabled && ! function() {
		...
		$("unmonitoredvideobtn") && f.push(new Element("a", {
			...
			href: "javascript:"
		}).replaces("unmonitoredvideobtn")), f.addEvent("click", function(a) {
			a.preventDefault(), startFirstChat(!0, void 0, void 0, void 0, !0)
		}), shouldForceUnmonitored && $("videobtnstatus").set("html", "&nbsp;"), testRTCSupport() ? $("videobtn").addEvent("click", function() {
			startFirstChat(!0)
...
function googleTranslateElementFullyLoaded() {
	if ("undefined" != typeof googTr && googTr.$ && googTr.R && "string" == typeof googTr.$ && "string" == typeof googTr.R && ("en" !== googTr.$.substr(0, 2).toLowerCase() || "en" !== googTr.R.substr(0, 2).toLowerCase()) && $("google_translate_wrapper") && $("google_translate_lower_container") && $("google_translate_lower_container").grab) {
		$("google_translate_lower_container").grab($("google_translate_wrapper")), $("google_translate_lower_container").grab(new Element("br"));
		var a = "English";
		googTr.B && "string" == typeof googTr.B.en && (a = googTr.B.en), $("google_translate_lower_container").appendText('(Select "' + a + '" to chat in English)')
	}
}
...
function makeTopicSettings(a) {
	function b(a) {
		...
		d.addEvent("click", function() {
			b.destroy(), topicManager.remove(a), e()
		}), b.grab(d), j.grab(b);
		var f = new Element("span");
		f.setStyle("font-size", 0), f.appendText(" "), j.grab(f)
	}
	...
	function d() {
		var a = l.get("value");
		l.set("value", ""), a = a.split(","), a = a.map(function(a) {
			return a.trim()
		});
	...
	function e() {
		l.value || topicManager.list().length ? k.setStyle("display", "none") : a && !IS_MOBILE ? k.setStyle("display", "block") : k.setStyle("display", "inline"), w.checked || topicManager.list().length ? x.setStyle("display", "block") : x.setStyle("display", "none")
	}
	...
	function g() {
		u.setStyle("display", "block"), shouldUseFbLikes && (w.set("checked", !0), e()), "0" !== Cookie.read("fblikes") && FB.getLoginStatus(function(a) {
			a.authResponse ? (w.set("checked", !0), f(!0), shouldUseFbLikes = !0) : f(!1), e()
		})
	}
	var h = new Element("div", {
	...
	if (a && !IS_MOBILE) {
		...
		try {
			h.setStyle("background", "-moz-linear-gradient(0deg, #F7F7F7, #FFF)"), h.setStyle("background", "-webkit-linear-gradient(0deg, #F7F7F7, #FFF)"), h.setStyle("background", "linear-gradient(0deg, #F7F7F7, #FFF)")
		} catch (i) {}
	...
	h.grab(j), $each(topicManager.list(), b);
	...
	l.addEvent("keydown", c), l.addEvent("keypress", c), l.addEvent("keyup", c), l.addEvent("keydown", function(a) {
		32 !== a.code || l.get("value") || a.preventDefault(), (13 === a.code || 188 === a.code) && (a.preventDefault(), d())
	}), l.addEvent("blur", d), h.grab(l), h.addClass("needsclick"), h.addEvent("click", function() {
		l.focus()
	});
	var m = new Element("div", {
		styles: {
	...
	var n = new Element("div"),
		o = new Element("a", {
			...
			events: {
				click: function(a) {
					a.preventDefault(), o.dispose(), n.grab(p), r.focus()
				}
			},
			styles: {
				"margin-left": "1.5em"
					...
					if (a.preventDefault(), !r.get("disabled")) {
						...
						c && (r.set("value", ""), r.set("disabled", !0), s.set("disabled", !0), loadTumblrTags(c, function(a) {
							if (r.set("disabled", !1), s.set("disabled", !1), a.success) {
								...
								e(), t.empty(), p.dispose(), n.grab(o), "undefined" != typeof _gaq && _gaq.push(["_trackEvent", "Tumblr tags", "Tags added"])
							} else t.empty(), t.setStyle("color", "red"), t.appendText(a.error)
						}))
					}
				}
			}
	...
	q.grab(r), p.grab(q), p.appendText(" ");
	...
	t.setStyle("font-size", "0.9em"), t.setStyle("max-width", "20em"), t.appendText("Omegle will try to learn your interests from posts and likes you've made public on Tumblr. Omegle is NOT requesting special access to your Tumblr account, and will NOT save your username, or give it to anyone."), p.grab(t);
	...
	w.addEvent("click", function(a) {
		w.checked ? (a.preventDefault(), FB.login(function(a) {
			...
			scope: "user_likes"
		})) : (shouldUseFbLikes = !1, f(!1)), setTimeout(e, 0)
	}), v.grab(w), v.appendText(" Add my Facebook likes as topics"), u.grab(v);
...
function killHeaders(a) {
	return delete a.headers["X-Requested-With"], delete a.headers["X-Request"], a
}
...
function makeSpyOptionsForm(a, b, c) {
	...
	return j.grab(k), j.appendText(" I want Omegle to reuse this question if it's good enough."), i.grab(j), e.grab(i), {
		form: e,
		focus: function() {
			h.focus()
		},
...
function startFlashing() {
	function a() {
		var a = b.pop();
		document.title = a[0], setFavicon(a[1]), b.unshift(a)
	}
	if (!IS_MOBILE && !isFlashing()) {
		var b = [
			["___Omegle___", "/static/favicon.png"],
			["Â¯Â¯Â¯OmegleÂ¯Â¯Â¯", "/static/altfavicon.png"]
		];
		flashingInterval = setInterval(a, 500), a(), $(document).addEvent("mousemove", mouseMove), $(document).addEvent("keydown", stopFlashing), $(document).addEvent("focus", stopFlashing), $(window).addEvent("mousemove", mouseMove), $(window).addEvent("keydown", stopFlashing), $(window).addEvent("focus", stopFlashing)
	}
}

function mouseMove(a) {
	var b = a.page;
	null === lastCoords || b.x == lastCoords.x && b.y == lastCoords.y || stopFlashing(), lastCoords = b
}
...
function setFavicon(a) {
	for (var b = $$("link"), c = 0; c < b.length; c++)
		if ("icon" === b[c].rel) return void(b[c].href = a);
...
function initSpinner(a) {
	function b(a, b, i) {
		k.clearRect(0, 0, g, h), d.width = d.width, k.drawImage(c, f, 0, e - f, f, 2 * f, f, e - f, f);
		var j = a / b;
		if (.75 > j) var l = 17 / 8 * Math.PI * Math.sin(j / .75 * (Math.PI / 2));
		else var l = Math.PI / 8 - Math.PI / 8 * (j - .75) / .25;
		i && (l = -l), k.save(), k.translate(1.6 * f, 1.6 * f), k.rotate(l), k.drawImage(c, 0, 0, f, f, .6 * -f, .6 * -f, f, f), k.restore()
	}
	if (window.CanvasRenderingContext2D) {
		...
		if (c && c.height) {
			...
			var e = c.naturalWidth || c.width,
				...
				i = c.width + c.height,
				j = 3 * c.height;
			d.width = g, d.height = h, d.style.width = i + "px", d.style.height = j + "px", d.style.marginLeft = "-" + c.height + "px", d.style.marginTop = "-" + c.height + "px";
			...
			}, initSpinner = function() {}, b(0, 1), c.setStyle("visibility", "hidden"), c.grab(d, "before"), !0
		}
	}
}
...
function startNewChat(a, b, c, d, e, f) {
	f && shouldForceUnmonitored && (e = !0), confirmTerms(e ? 2 : 1, function() {
		...
		function l(a) {
			...
			if (k() || (scrollElt.scrollTo ? scrollElt.scrollTo(scrollElt.scrollLeft, j()) : scrollElt.scrollTop = j()), b && $(Da) != $(document.activeElement) && Da.focus(), IS_MOBILE && i(), a || void 0 === a)
				for (var c = 50; 500 >= c; c += 150) setTimeout(function() {
					l(!1)
				}, c)
		}
		...
		function m(a, b) {
			...
			c.setStyle("display", "none"), c.set("method", "post"), c.set("target", "_blank"), c.set("action", "http://logs.omegle.com/generate"), c.set(b), a = a || {
				host: 1
			};
			var d = {
				log: JSON.encode(Na),
			...
			lb && (d.topics = JSON.encode(lb)), mb && (d.identdigests = mb), d = $extend(d, a), $each(d, function(a, b) {
				...
				c.grab(d)
			}), $(document.body).grab(c), c.submit(), setTimeout(function() {
				c.dispose()
			}, 0)
		}
		...
		function o(a) {
			if (a) {
				...
				if (b)
					for (var d = 0; d < a.length; d++) a[d].percentage || (a[d].percentage = (100 - c) / (b + 1))
			}
		}
		...
		function q(a) {
			if (o(a.tests), o(a.variants), a.tests)
				for (var b = 0; b < a.tests.length; b++) o(a.tests[b].variants)
		}
		...
		function t(a, b) {
			return s(function() {
				...
				return c.grab(a), 0 === Ya.length || b ? ra.grab(c) : c.inject(Ya[0].element, "before"), c
			})
		}

		function u(a, b) {
			var c, d;
			void 0 === b || b && "string" != typeof b ? (c = !0, d = null) : "string" == typeof b ? (c = !0, d = b) : c = !1, "string" == typeof a && null === d && (d = a), c && !Oa && null !== d && Na.push([d])
		}
		...
		function w(a) {
			"undefined" != typeof Recaptcha && Recaptcha.destroy(), null !== Za && Za.dispose(), Za = t(a), initialLogIsRecaptcha = !1, Va = !1
		}

		function x(a, b) {
			return "undefined" != typeof Recaptcha && Recaptcha.destroy(), Va && "string" == typeof a ? ($(Za.firstChild).empty(), $(Za.firstChild).appendText(a), void u(a, b)) : (null !== Za && Za.dispose(), Za = v(a, !1, !1, "undefined" == typeof b ? !1 : b), initialLogIsRecaptcha = !1, void(Va = "string" == typeof a))
		}
		...
		function y(a) {
			...
			c.appendText("Stranger: "), b.grab(c), b.appendText(" ");
			var d = new Element("span", {
				html: a
			});
			b.grab(d), t(b), Oa || Na.push(["Stranger:", d.get("text")])
		}
		...
		function z(a, b, c) {
			...
			var e = !0;
			if ($each(c.split("\n"), function(a) {
					e || d.grab(new Element("br")), e = !1, d.appendText(a)
				}), IS_MOBILE) {
				var f = new Element("div", {
					"class": "msggroup-msg"
				});
				if (f.grab(d), Xa === a) s(function() {
					...
					h.grab(f), g.grab(h), t(g), Wa = h, Xa = a
				}
			} else {
				var i = new Element("p", {
						"class": b
				...
				j.appendText(a + ":"), i.grab(j), i.appendText(" "), i.grab(d), t(i)
			}
			Oa || Na.push([a + ":", c])
		}
		...
		function F() {
			_a = !0, ($("logo") || logoElt) && ($("logo") || logoElt).removeEvent("click", H), null !== ab && (clearInterval(ab), ab = null), Ha && ($(window).removeEvent("resize", Ha), $(window).removeEvent("orientationchange", Ha)), IS_MOBILE ? ($(document.body).removeEvent("scroll", i), $(document).removeEvent("scroll", i)) : ($(document).removeEvent("keydown", g), $(document).removeEvent("keyup", h)), ma.dispose()
		}
		...
		function G(f, g, h, i, j) {
			if (!_a) {
				...
				f && (g = null, h = !1, i = !1), void 0 === g && (g = b), void 0 === h && (h = c), void 0 === i && (i = d), void 0 === j && (j = e), confirmTerms(j ? 2 : 1, function() {
					a && !f && ga(), F(), startNewChat(f, g, h, i, j)
				})
			}
		}
		...
		function H() {
			...
			a && ga(), $(document.body).removeClass("inconversation"), $(document.body).removeClass("videochat"), $("logo").setStyle("cursor", "default"), F(), showIntro()
		}
		...
		function I() {
			if (!IS_MOBILE) {
				if (null === unmonSexyButton) {
					...
					var b = "/static/sexbtn";
					unmonSexyTrack = "", window.devicePixelRatio && window.devicePixelRatio > 1 ? unmonSexyButton.set("src", b + "@2x.png?xx") : unmonSexyButton.set("src", b + ".png?xx")
				}
				if (unmonSexyButton.addEvent("click", function() {
						null !== cb && cb();
						var b = "unmon-upper-" + (shouldForceUnmonitored ? "" : "not") + "forced-";
						b += a ? "video" : "text", confirmAdultSite() && window.open("https://wawadmin.omegle.com/redir/" + (IS_MOBILE ? "mob" : "y") + "?track=" + b + unmonSexyTrack)
					}), null === unmonGayButton) {
					...
					unmonGayTrack = "", window.devicePixelRatio && window.devicePixelRatio > 1 ? unmonGayButton.set("src", c + "@2x.png") : unmonGayButton.set("src", c + ".png")
				}
				unmonGayButton.addEvent("click", function() {
					null !== cb && cb();
					var b = "unmon-upper-" + (shouldForceUnmonitored ? "" : "not") + "forced-";
					b += a ? "video" : "text", confirmAdultSite() && window.open("https://wawadmin.omegle.com/redir/gay?track=" + b + unmonGayTrack)
				});
				var d = new Element("div");
				d.grab(unmonSexyButton), IS_MOBILE || d.grab(unmonGayButton);
				var f = new Element("span", {
					html: "&times;",
					styles: {
						"font-weight": "bold",
					...
					events: {
						click: function() {
							g.dispose(), chatPervTrack = [], ob.dispose(), pb.dispose()
						}
					}
				});
		...
		function J(f) {
			...
			function h(a) {
				if ("video" !== a || !IS_MOBILE && testRTCSupport()) {
					if (y)
						if (y = !1, "video" === a) var b = "turn on " + a;
						else var b = "switch to " + a;
					else var b = a;
					x.appendText(" or "), x.grab(new Element("a", {
						href: "javascript:",
						text: b,
						events: {
							click: function(b) {
								b.preventDefault(), g(a)
							}
						}
					}))
				}
			...
			function k(a) {
				aurrp = a, Cookie.write("aurrp", a ? "1" : "0", {
					duration: 365,
					domain: document.domain,
					path: "/"
				})
			...
			function o() {
				function a() {
					if (l.empty(), e) f || (f = !0, i.set("text", "Not automatically rerolling."), j.dispose(), h.grab(m), P("new"));
						...
						g && l.set("text", " (Paused while you move your mouse)"), i.set("text", a), P("new", g ? void 0 : d)
					}
				}
				...
				function c() {
					return e || _a ? void $(document.body).removeEvent("mousemove", c) : (ab && (clearInterval(ab), ab = null), p && (clearTimeout(p), p = null), g = !0, a(), void(p = setTimeout(function() {
						p = null, g = !1, a(), ab || e || _a || (ab = setInterval(b, 1e3))
					}, 200)))
				}
				var d = 1,
					e = !Z || cb(),
					...
					i = new Element("span");
				h.grab(i), h.appendText(" ");
				var j = new Element("input");
				j.set("type", "button"), j.set("value", "Stop"), cb = function() {
				...
				m.setStyle("color", "black"), m.setStyle("font-weight", "normal");
				var n = new Element("input");
				n.set("type", "checkbox"), n.set("checked", Z), n.addEvent("change", function() {
					k(n.checked)
				}), m.grab(n), m.appendText(" Auto-reroll next time"), a(), v(h, !1, !1);
			...
			function q() {
				var a;
				a = e ? Qa : currentAffiliate, a && r(a)
			}

			function r(b) {
				b = p(b.variants, b), a && b.videoMode ? b = $merge(b, b.videoMode) : !a && b.textMode && (b = $merge(b, b.textMode));
				var c = a ? "video" : "text";
				b.trackCode && (c = b.trackCode), b.baseTrackCode && (c = b.baseTrackCode + "-" + c);
				...
				if (b.text) {
					...
					i.setStyles({
						...
						"-webkit-border-radius": " 0.5em",
						border: "1px solid #CCC"
					}), i.style.lineHeight = "1.5", b.style && i.setStyles(b.style), i.set("text", b.text), g.grab(i)
				}
				e.grab(g);
				var j = new Element("span");
				j.set("html", "&times;"), j.setStyles({
					cursor: "default",
					color: "black",
					"font-weight": "bold"
				}), j.addEvent("click", function() {
					currentAffiliate = null, d.destroy()
				}), b.noCloseButton || (e.appendText(" "), e.grab(j));
				var k = new Element("div");
				return k.setStyle("cursor", "pointer"), k.addEvent("click", function(a) {
					var b = $(a.target);
					g.hasChild(b) || g === b || j === b || j.hasChild(b) || window.open(f, "_blank")
				}), k.grab(e), d = t(k), (b.bottomPositioning || void 0 === b.bottomPositioning) && (d.setStyle("height", k.getSize().y + "px"), k.setStyles({
					position: "absolute",
					bottom: "0.5em"
				})), !0
			}
			if (!db) {
				db = !0, chatOddEven = !chatOddEven, Q(), newChatButton.removeEvents(), null !== unmonSexyButton && unmonSexyButton.removeEvents(), null !== unmonGayButton && unmonGayButton.removeEvents(), B(), Oa = !0, initialLogIsRecaptcha && ("undefined" != typeof Recaptcha && Recaptcha.destroy(), Za.dispose(), Za = null, initialLogIsRecaptcha = !1), eb && (eb.destroy(), eb = null);
				for (var s = 0; s < $a.length; s++) $a[s].dispose();
				if (mots = [], a) {
					try {
						Ub.close(), delete Ub.ontrack, delete Ub.onicecandidate
					} catch (u) {}
					Ub = null, sb && (sb.srcObject = null), _()
				}
				Bb && (clearTimeout(Bb), Bb = null), a || IS_MOBILE || setTimeout(l, 300), $(document.body).removeClass("inconversation"), Da.set("disabled", !0), Da.addClass("disabled"), Ga.set("disabled", !0), Da.blur(), Ga.blur(), P("new"), window.onbeforeunload = null, $(window).removeEvent("unload", M), stopped = !0;
				var w = (ra.get("html"), null);
				document.createRange && (window.getSelection || document.getSelection) && (w = document.createRange(), w.selectNodeContents(ra)), ja && (bb = makeSpyOptionsForm(G, b, d), t(bb.form), IS_MOBILE || bb.focus());
				var x = new Element("div", {
				...
				if (c || b ? (h("text"), h("video")) : a ? (h("text"), e || h("unmoderated section")) : h("video"), IS_MOBILE && y || v(x, !1, !1), qb && I(), !c && !b) {
					...
					D.addEvent("click", i), C.grab(D), C.appendText(" My language"), A.grab(C), A.appendText(" ");
					...
					F.addEvent("click", i), E.grab(F), E.appendText(" English"), A.grab(E), A.setStyle("display", "none"), z.grab(A);
					var H = makeShouldUseLikesCheckbox(),
						J = H.getElement(".shoulduselikescheckbox");
					J.addEvent("click", j), j(), z.grab(H);
					var K = new Element("a", {
						href: "javascript:",
						text: "(Settings)"
					});
					if (shouldUseFbLikes || topicManager.list().length || (J.set("checked", !1), J.set("disabled", !0), K.set("text", "(Enable)")), K.addEvent("click", function(a) {
							a.preventDefault(), null !== cb && cb(), A.dispose(), z.empty();
							var b = makeTopicSettings();
							z.grab(A), z.grab(b), b.getElement("input").focus(), J = b.getElement(".shoulduselikescheckbox"), J.addEvent("click", j), L && L.dispose()
				...
				IS_MOBILE ? O.set("text", "Great chat? Save the log!") : O.set("text", "Great chat?"), O.addEvent("click", function() {
					m()
				}), N.grab(O);
				var R = [],
					S = new Element("a");
				...
				}), U.push(Y), IS_MOBILE || (N.appendText(" Save the log: "), N.grab(middotify(R)), N.appendText(" â€¢Â Or post log to: "), N.grab(middotify(U)));
				var Z = aurrp;
		...
		function K(a) {
			function b() {
				var b = new Element("div");
				w(b), IS_MOBILE || Za.setStyles({
					position: "absolute",
					bottom: "0"
				}), initialLogIsRecaptcha = !0, grecaptcha.render(b, {
					sitekey: a,
					callback: function(a) {
						x("Verifying..."), Ma.submitRecaptcha(a)
					},
		...
		function L(a) {
			K(a), "undefined" != typeof _gaq && _gaq.push(["_trackEvent", "CAPTCHA", "CAPTCHA shown"])
		}
		...
		function O() {
			if (!za.get("disabled")) switch (nb) {
				case "disconnect":
					P("really"), Da.get("disabled") || IS_MOBILE || Da.focus();
					break;
				case "really":
					M();
					break;
		...
		function P(a, b) {
			...
			void 0 !== b && (c += "..."), za.set("text", c), za.grab(new Element("div", {
				"class": "btnkbshortcut",
				text: "Esc"
			})), nb = a, ya.removeClass("reallybtn"), "new" === a ? ya.addClass("newbtn") : "really" === a && ya.addClass("reallybtn")
		}
		...
		function R() {
			...
			var d = new Element("button", {
				...
				events: {
					click: function(a) {
						a.preventDefault(), cb && cb(), confirmAdultSite() && window.open("https://wawadmin.omegle.com/redir/y?track=" + c)
					}
				}
			});
			b.grab(d), ob.grab(b), xa.grab(ob, "after"), pb = new Element("td", {
			...
			var f = new Element("div", {
				...
				g = new Element("button", {
					"class": "lowergaybtn",
					text: "Â gay camsÂ  (free" + (e ? "" : ", 18+") + ")",
					events: {
						click: function(a) {
							a.preventDefault(), cb && cb(), confirmAdultSite() && window.open("https://wawadmin.omegle.com/redir/gay?track=" + c)
						}
					}
				});
			return f.grab(g), pb.grab(f), ob.grab(pb, "after"), "undefined" == typeof doUnmonSexyTest && (doUnmonSexyTest = Math.random() < .5), c += "-none-" + (doUnmonSexyTest ? "y" : "n"), Q = function() {
				var a = ["ðŸ’‹ *soft moan*", "adult cams (free)"];
				a[1] = "girlÂ cams Â Â (free)Â Â ";
				for (var b = null;
				...
				f = "", c.setStyles({
					...
					background: "red",
					background: "#FF7F00"
				}), lastActiveUnmonSexy = c, e.setStyles({
					"box-shadow": "none",
		...
		function T() {
			...
			if (rb.getSize && rb.getPosition && $(window).getSize) {
				...
				var f = 4 / 3,
					g = (b - 8 - d) / 2,
					h = f * g;
				a.x - h <= 400 && (h = a.x - 400, g = h / f, b = 2 * g + 8 + d), rb.setStyles({
					width: Math.floor(h) + "px",
					height: Math.floor(b) + "px"
				}), new Elements([tb, sb]).setStyles({
					width: Math.floor(h) + "px",
					height: Math.floor(g) + "px"
				}), new Elements([ta, pa]).setStyle("margin-left", h + 8 + "px"), ub.setStyles({
		...
		function U() {
			...
			if (a) {
				...
				wb = "", A("you", a), Ma.sendMessage(a), P("disconnect")
			}
		}
		...
		function W() {
			xb = null, Ma.stopTyping()
		}

		function X() {
			confirmAdultSite() && (Y("accept"), window.open("https://wawadmin.omegle.com/redir/y?track=interchat-" + Ib))
		}

		function Y(a) {
			(new Image).src = "https://wawadmin.omegle.com/redir/interchatexit?track=" + a + "-" + Ib
		}

		function Z() {
			(new Image).src = "https://wawadmin.omegle.com/redir/interchatenter?track=" + Ib
		}

		function _() {
			ub.setStyle("display", "none"), sb.removeEventListener("play", _)
		}

		function aa() {
			x("Connection error."), J()
		}
		...
		function da(a, b) {
			for (var c = a.split(" "), d = new Array, e = 0, f = 0; f < c.length; f++) 3 === e && (d[e++] = b), c[f] !== b && (d[e++] = c[f]);
			return d.join(" ")
		}
		...
		function ea(a, b) {
			for (var c = a[b].split(" "), d = a.length - 1; d >= 0; d--) {
				...
				if (e) {
					var f = c.indexOf(e); - 1 !== f && c.splice(f, 1), a.splice(d, 1)
				}
			}
			return a[b] = c.join(" "), a
		}
		...
		function fa(a) {
			a.sdp = ba(a.sdp), Ub.setLocalDescription(a).then(function() {
		...
		function ha() {
			...
			a.length ? cameraName = a[0].label : cameraName = "", Ub.addStream ? Ub.addStream(userMedia) : userMedia.getTracks().forEach(function(a) {
				Ub.addTrack(a, userMedia)
			}), x("Connecting to server..."), IS_MOBILE || ub.setStyle("display", "block"), sb.addEventListener("play", _, !1), Ma.connect(null, null, !1, !1, yb, Ab, e ? "unmon" : null, Tb, cameraName, !0, Cb, Db, Eb), serverManager.unsetKnownGood(), !e && antinudeServers.length && (Bb = setTimeout(function() {
				function a(b) {
					Bb = null, m.getContext("2d").drawImage(tb, i, j + d * b, c * g, d * h), b + 1 == e ? m.toBlob(function(a) {
						if (antinudeServers.length) {
							var b = antinudeServers[$random(0, antinudeServers.length - 1)],
								c = new XMLHttpRequest;
							a = a.slice(0, a.size, "application/octet-stream"), c.open("POST", "https://" + b + "/upload?camera=" + encodeURIComponent(cameraName) + "&num_frames=" + e + "&frame_delay=" + f + "&randid=" + encodeURIComponent(randID)), c.withCredentials = !0, c.send(a)
						}
				...
				Bb = null;
				var b = new Date;
				if (!(lastScreenshotTime && 6e4 > b - lastScreenshotTime || (lastScreenshotTime = b, Math.random() > screenshotPercent))) {
					var c = 320,
						d = 240,
						e = 4,
						f = 300,
		...
		$("appstore") && $("appstore").destroy(), $("footer") && $("footer").destroy(), mobileAdWrapper && mobileAdWrapper.setStyle("display", "none"), stopFlashing(), IS_MOBILE || startSpinner();
		var ia = new Date,
			ja = "string" == typeof b,
			ka = !1,
			la = !1;
		a && totalVideoChatsStarted++, $(document.body).addClass("inconversation"), a ? $(document.body).addClass("videochat") : $(document.body).removeClass("videochat");
		...
		IS_MOBILE || ra.setStyles({
			position: "relative",
			"min-height": "100%"
		}), qa.grab(ra), pa.grab(qa);
		var sa = new Element("div", {
			"class": "logwrapperpush"
		});
		pa.grab(sa), oa.grab(pa);
		...
		ya.grab(za), xa.grab(ya), wa.grab(xa);
		...
		Ga.grab(new Element("div", {
			"class": "btnkbshortcut",
			text: "Enter"
		})), Fa.grab(Ga), Ea.grab(Fa), IS_MOBILE || wa.grab(Ea), va.grab(wa), ua.grab(va), ta.grab(ua), oa.grab(ta), na.grab(oa), ma.grab(na), $(document.body).grab(ma), $(document.body).scrollTop = $(document.body).scrollHeight;
		var Ha = null,
			Ia = null,
			Ja = null,
			Ka = null,
		...
		Ma.addEvent("connectedToServer", function() {
			za.set("disabled", !1), window.onbeforeunload = N, $(window).addEvent("unload", M)
		}), Ma.addEvent("failedToConnect", function(a) {
			x("Error connecting to server. Please try again."), J(), "undefined" != typeof _gaq && _gaq.push(["_trackEvent", "Omegle connect error", a])
		});
		var eb = null,
			fb = null,
			gb = !1,
		...
		Ma.addEvent("waiting", function() {
			function a() {
				fb && (clearTimeout(fb), fb = null), eb && (Ma.stopLookingForCommonLikes(), eb.destroy(), eb = null)
			}
			...
			e.addEvent("click", a), eb.grab(e), eb.appendText(" instead."), c.grab(eb), fb = setTimeout(function() {
				gb = !0, a()
			}, 1e4), x(c)
		});
		var ib = !1;
		Ma.addEvent("strangerConnected", function() {
			if (!db)
				if (null !== hb && +new Date - hb > 1e3 && startFlashing(), "undefined" != typeof _gaq && _gaq.push(["_trackEvent", "Omegle chat connected", Gb]), ib = !0, serverManager.setKnownGood(), fb && (clearTimeout(fb), fb = null), ja) x("You're now watching two strangers discuss your question!", "You're watching two strangers discuss your question on Omegle!");
				else {
					var b = new Date;
					if (11 === b.getMonth() && 25 === b.getDate()) var c = "merry Christmas";
					else var c, d = ["STAND WITH HONG KONG AGAINST THE CCP"],
						c = d[Math.floor(d.length * Math.random())];
					x("You're " + (IS_MOBILE ? "" : "now ") + "chatting with a random stranger. Say " + c + "!", "You're chatting with a random stranger on Omegle!"), gb && v("Omegle couldn't find anyone who shares interests with you, so this stranger is completely random. Try adding more interests!", !1, !1, !1), Da.set("disabled", !1), Da.removeClass("disabled"), Ga.set("disabled", !1), IS_MOBILE || Da.focus(), a && window.navigator.userAgent.indexOf("Edge") > -1 && v("Omegle video chat might not work well in Microsoft Edge. Please upgrade to Firefox or Chrome.")
				}
		}), Ma.addEvent("gotMessage", function(a) {
			C(), a = a.replace(/^[\r\n]+/g, ""), navigator.notification && navigator.notification.beep && navigator.notification.beep(1), navigator.vibrate && navigator.vibrate(333), A("stranger", a)
		}), Ma.addEvent("gotMessageHTML", function(a) {
			C(), y(a)
		}), Ma.addEvent("strangerDisconnected", function() {
			v("Stranger has disconnected."), J()
		}), Ma.addEvent("typing", E), Ma.addEvent("stoppedTyping", C), Ma.addEvent("recaptchaRequired", L), Ma.addEvent("recaptchaRejected", L), Ma.addEvent("connectionDied", function(a) {
			var b = "Technical error";
			a && (b += ": " + a + " Sorry. :( Omegle understands if you hate it now, but Omegle still loves you."), v(b), serverManager.unsetKnownGood(), "undefined" != typeof _gaq && _gaq.push(["_trackEvent", "Omegle error", a ? a : "(error)", Ma.server]), J()
			...
			d.appendText(a), b.grab(d), Na.push(["Question to discuss:", a]), t(b)
		}), Ma.addEvent("spyMessage", function(a, b) {
			if ("Stranger 1" === a) var c = "youmsg";
			else var c = "strangermsg";
			B(a), startFlashing(), z(a, c, b)
		}), Ma.addEvent("spyDisconnected", function(a) {
			v(a + " has disconnected"), J()
		}), Ma.addEvent("spyTyping", D), Ma.addEvent("spyStoppedTyping", B), Ma.addEvent("error", function(a) {
			v(a), J()
		});
		var jb = !1;
		Ma.addEvent("serverMessage", function(a) {
			-1 !== a.indexOf("language") && (jb = !0, IS_MOBILE || "undefined" == typeof googTr || (a += ' (Select "English" from the menu in the corner to disable.)')), v(a, !1)
		}), Ma.addEvent("antinudeBanned", function(a) {
			v("Banned."), J(), null !== cb && cb(), top.location.href = a
		});
		var kb = null,
			lb = null;
		Ma.addEvent("commonLikes", function(a) {
			if (a.length) {
				lb = a;
				for (var b = "You both like ", c = 0; c < lb.length; c++) b += lb[c], c < lb.length - 1 && (b += ", "), c == lb.length - 2 && (b += "and ");
				b += ".", kb && kb.destroy(), kb = v(b)
			}
		...
		var nb = "disconnect";
		Ga.addEvent("click", U), P("disconnect"), za.addEvent("click", O);
		var ob, pb, qb = !1;
		if (R() || e || chatPervTrack.push(!1), "undefined" == typeof doAVCtest && (doAVCtest = Math.random() < .5), a) {
			$("videowrapper") || $(document.body).grab(new Element("div", {
			...
			})), window.testOverrideConstraints && ($("othervideo").src = "/static/spinner.mp4"), $("othervideo").autoplay = !0, $("othervideo").setAttribute("playsinline", "playsinline"), $("othervideo").setAttribute("webkit-playsinline", "playsinline")), $("selfvideo") || ($("videowrapper").grab(new Element("video", {
				id: "selfvideo",
				events: {
					contextmenu: function() {
						return !1
			...
			})), $("selfvideo").muted = !0, $("selfvideo").autoplay = !0, $("selfvideo").setAttribute("playsinline", "playsinline"), $("selfvideo").setAttribute("webkit-playsinline", "playsinline")), $("othervideospinner") || $("videowrapper").grab(new Element("div", {
				...
				return !1
			}).setStyle("opacity", "0.66"))), e && !$("abovevideosexybtn") && $("videowrapper").grab(new Element("div", {
				styles: {
					background: "red",
					color: "white",
					"font-size": "30px",
				...
				events: {
					click: function(a) {
						a.preventDefault(), cb && cb(), confirmAdultSite() && window.open("https://wawadmin.omegle.com/redir/y?track=avc-108-" + (doAVCtest ? "y" : "n"))
					}
				},
			...
			var rb = $("videowrapper"),
				...
				vb = $("videologo");
			$("abovevideosexybtn");
			T(), $(window).addEvent("resize", T), $(window).addEvent("orientationchange", T), Ha = T
		} else var rb = null,
			sb = null,
			tb = null;
		...
		Da.addEvent("keydown", function(a) {
			...
			setTimeout(function() {
				Da.value !== wb && (wb = Da.value, null === xb && Ma.typing(), V(), xb = setTimeout(W, 5e3))
			}, 0)
		...
		if (!c && !b && !e) {
			if (shouldUseLikes) {
				...
				Ab = topicManager.list(), zb = Ab.length || null !== yb
			}
			"none" !== collegeMode && collegeAndAuth && (Eb = "any" === collegeMode, Cb = collegeAndAuth[0], Db = collegeAndAuth[1])
		}
		var Gb = function() {
			var d = [];
			return IS_MOBILE && d.push("mobile"), b ? d.push("spy") : c ? d.push("spyee") : a ? d.push("video") : d.push("text"), e && (d.push("unmonitored"), shouldForceUnmonitored && d.push("(forced)")), zb && (d.push("topical"), yb && d.push("(FB)")), "none" !== collegeMode && Db && d.push("college"), d[0] = d[0][0].toUpperCase() + d[0].substr(1), d.join(" ")
		}();
		...
		if (e) {
			if ("undefined" == typeof unmonChatCount && (unmonChatCount = 0, unmonAdCount = 0), unmonAdCount < 1 && unmonChatCount >= 4) {
				...
				Pb.grab(Qb), Lb.grab(Nb), Lb.grab(Pb);
				var Rb = new Element("div", {
						...
						events: {
							click: function() {
								confirmAdultSite() && (Y("gayaccept"), window.open("https://wawadmin.omegle.com/redir/gay?track=interchat-" + Ib))
							}
						}
					}),
					Sb = new Element("span", {
				...
				return Rb.grab(Sb), Lb.grab(Rb), Jb.grab(Lb), w(Jb), za.set("disabled", !0), void Z()
			}
			unmonChatCount++
		}
		var Tb = null;
		if (shouldUseEnglish && !zb || ("undefined" != typeof googTr && googTr.R && "string" == typeof googTr.R && googTr.R.length >= 2 ? Tb = googTr.R.substr(0, 2) : "undefined" != typeof navigator && "string" == typeof navigator.language && (Tb = navigator.language.substr(0, 2))), a) {
			...
			Ma.addEvent("icecandidate", function(a) {
				...
				Xb = !0, null !== Ub && Ub.createOffer(WEB_RTC_MEDIA_CONSTRAINTS).then(fa, aa)
			}), Ma.addEvent("rtcpeerdescription", function(a) {
				a = new RTCSessionDescription(a), null !== Ub && Ub.setRemoteDescription(a).then(function() {
					Zb = !0;
				...
				x("NotAllowedError" === a.name ? "Camera blocked. Please enable it and try again." : a.message ? "Error with camera: " + a.message : "Error with camera: " + a), J(!0)
			}))
		} else Ma.connect(null, b, c, d, yb, Ab, e ? "unmon" : null, Tb, null, !1, Cb, Db, Eb), serverManager.unsetKnownGood()
	})
}
...
function requestFullscreen(a) {
	a = a || document.documentElement, a.requestFullscreen ? a.requestFullscreen() : a.webkitRequestFullscreen && a.webkitRequestFullscreen()
}
window.onerror = function(a, b, c, d) {
	"undefined" == typeof _gaq && (_gaq = []), _gaq.push(["_trackEvent", "JSerror", b + ":" + c + ":" + d, a + ""])
...
var COMETBackend = new Class({
		...
		connect: function(a, b, c, d, e, f, g, h, i, j, k, l, m, n) {
			var o = this;
			o.server = a, o.stratusNearID = b, o.askedQuestion = c, o.wantsSpy = d, o.canSaveQuestion = e, o.fbAccessToken = f, o.topics = g, o.group = h, o.lang = i, o.camera = j, o.enableWebRTC = k, o.college = l, o.collegeAuth = m, o.anyCollege = n, subdomainManager.subdomainWindow(a, function(a) {
				o.reqWindow = a, o.gotReqWindow()
			})
		},
		resume: function(a, b) {
			var c = this;
		...
		gotReqWindow: function() {
			...
			"string" == typeof a.askedQuestion && (c += "&ask=" + encodeURIComponent(a.askedQuestion)), "string" == typeof a.fbAccessToken && (c += "&fbaccesstoken=" + encodeURIComponent(a.fbAccessToken)), a.wantsSpy && (c += "&wantsspy=1"), a.canSaveQuestion && (c += "&cansavequestion=1"), a.topics && a.topics.length && (c += "&topics=" + encodeURIComponent(JSON.encode(a.topics))), a.group && (c += "&group=" + encodeURIComponent(a.group)), a.lang && (c += "&lang=" + encodeURIComponent(a.lang)), a.camera && (c += "&camera=" + encodeURIComponent(a.camera)), a.enableWebRTC && (c += "&webrtc=1"), a.college && (c += "&college=" + encodeURIComponent(a.college)), a.collegeAuth && (c += "&college_auth=" + encodeURIComponent(a.collegeAuth)), a.anyCollege && (c += "&any_college=1");
			var d = null,
				e = killHeaders(new a.reqWindow.Request.JSON({
					...
					onSuccess: function(b) {
						if (null !== d) {
							...
							a.clientID = b.clientID, a.fireEvent("connectedToServer"), b.events && a.gotEvents(b.events), a.getEvents()
						}
					},
					onFailure: function() {
			...
			d = setTimeout(function() {
				d = null, e.cancel(), a.fireEvent("failedToConnect")
			}, 1e4), e.post()
		},
		getEvents: function(a) {
			if (void 0 === a && (a = 0), !this.stopped) {
				if (a > 2) {
					var b = this.stopped;
					return this.stopped = !0, void(b || this.fireEvent("connectionDied", "Lost contact with server, and couldn't reach it after 3 tries."))
				}
				var c = this;
				if (window.useExperimental && window.WebSocket) {
					...
					return d.onerror = function(b) {
						...
						if (null === b) {
							var d = c.stopped;
							c.stopped = !0, d || c.fireEvent("connectionPermanentlyDied", "Server was unreachable for too long and your connection was lost.")
						} else c.gotEvents(b)
					})
				}
				var e = null,
				...
				f.post({
					id: this.clientID
				}), c.lastEvReq = f, e = setTimeout(function() {
					e = null, f.cancel(), c.getEvents(a)
				}, 7e4)
			}
		},
		...
		disconnect: function() {
			this.lastEvReq && (this.lastEvReq.cancel(), this.lastEvReq = null), this.sendPOST("/disconnect"), this.stopped = !0
		},
	...
	MetaBackend = new Class({
		Implements: [Options, Events],
		initialize: function(a) {
			this.setOptions(a), this.numResumes = 0, this.stopped = !1, this.server = null
		},
		plugInBackend: function() {
			...
			$each(a, function(a) {
				b.backend.addEvent(a, function() {
					("strangerDisconnected" === a || "error" === a || "spyDisconnected" === a || "antinudeBanned" === a) && (b.stopped = b.backend.stopped), b.fireEvent(a, arguments)
				})
				...
				if (serverManager.unsetKnownGood(), b.backend.clientID && b.numResumes < 3 && !b.stopped) {
					...
					b.backend.removeEvents(), b.backend = new COMETBackend, b.plugInBackend(), b.server = serverManager.pickServer(), b.backend.resume(b.server, a)
				} else b.stopped = !0, b.fireEvent("connectionDied", arguments)
			}), b.backend.addEvent("connectionPermanentlyDied", function() {
				serverManager.unsetKnownGood(), b.stopped = !0, b.fireEvent("connectionDied", arguments)
			}), b.backend.addEvent("failedToConnect", function() {
				serverManager.unsetKnownGood(), b.numResumes < 3 ? (b.numResumes++, b.backend.removeEvents(), b.connect.apply(b, b.connectArgs)) : (b.stopped = !0, b.fireEvent("failedToConnect", b.backend.server))
			}), b.backend.addEvent("permanentlyFailedToConnect", function() {
				serverManager.unsetKnownGood(), b.stopped = !0, b.fireEvent("failedToConnect", b.backend.server)
			})
		},
		connect: function() {
			this.backend = new COMETBackend, this.plugInBackend(), this.server = serverManager.pickServer(), this.connectArgs = arguments;
		...
		disconnect: function() {
			this.stopped = !0, this.backend && this.backend.disconnect()
		},
		submitRecaptcha: function(a) {
...
window.addEvent("domready", onReady), window.addEvent("load", onLoad);
var topicManager = function() {
		...
		return e && (d = JSON.decode(e)), a(), {
			...
			remove: function(c) {
				for (var e = b(c), f = 0; f < d.length; f++)
					if (b(d[f]) === e) return d.splice(f, 1), a(), !0;
				return !1
			},
			normalize: b,
			check: c
	...
	subdomainManager = function() {
		function a(a) {
			...
			b.setStyle("display", "none"), $(document.body).grab(b)
		}
		var b = {},
			c = {};
		return {
			subdomainWindow: function(d, e) {
				void 0 !== Browser.Request().withCredentials ? e(window) : b[d] ? e(b[d]) : (c[d] ? c[d].push(e) : c[d] = [e], a(d))
			},
			fixUrl: function(a, b) {
		...
		var a = [],
			...
			d = {
				...
				pickServer: function() {
					...
					for (;;) {
						var d = a.shift();
						if (a.push(d), !(/^front([1-9]|10)\./.test(d) && Math.random() < .333)) break
					}
					return c = d, d
				},
				setServerList: function(b) {
					...
					for (var e = 0; e < b.length; e++) {
						var f = b[e]; - 1 === a.indexOf(f) && (d = !0, a.splice(Math.floor(Math.random() * (a.length + 1)), 0, f))
					}
					d && this.unsetKnownGood();
					for (var e = 0; e < a.length; e++) {
						var f = a[e]; - 1 === b.indexOf(f) && a.splice(e, 1)
					}
				}
			};
		return d.setServerList(["front1", "front2", "front3", "front4", "front5", "front6", "front7", "front8", "front9", "front10", "front11", "front12", "front13", "front14", "front15", "front16", "front17", "front18", "front19", "front20", "front21", "front22", "front23", "front24", "front25", "front26", "front27", "front28", "front29", "front30", "front31", "front32", "front33", "front34", "front35", "front36", "front37", "front38", "front39", "front40", "front41", "front42", "front43", "front44", "front45", "front46", "front47", "front48"]), d
	}(),
	...
	chatOddEven = !0,
	chatPervTrack = [],
	logoShadowImg, totalVideoChatsStarted = 0,
	userMedia = null,
	WEB_RTC_CONFIG = {
		iceServers: [{
